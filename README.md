...
[Icons](http://www.flaticon.com/packs/packs/pokemon-go/) used in the front-end are made by [Roundicons Freebies](http://www.flaticon.com/authors/roundicons-freebies/) from [www.flaticon.com](http://www.flaticon.com/). License: CC 3.0 BY can be found [here](http://creativecommons.org/licenses/by/3.0/). Discord [icon](http://www.flaticon.com/free-icon/rocket_178158) used is made by [Flat Icons](http://flat-icons.com/) from [www.flaticon.com](http://www.flaticon.com/).
