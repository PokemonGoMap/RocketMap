...
import requests
import site
site.addsitedir('/home/snapper67/.virtualenvs/pokemon/lib/python2.7/site-packages')
# site.addsitedir('../lib/python2.7/site-packages')

activate_this = os.path.expanduser("~/.virtualenvs/pokemon/bin/activate_this.py")
# activate_this = os.path.expanduser("../bin/activate_this.py")
...
import sys
sys.path.insert(0, "/home/snapper67/webapps/pokemon/htdocs/pogom")
sys.path.insert(0, "/home/snapper67/webapps/pokemon/htdocs/pogom/")
sys.path.insert(0, "/home/snapper67/webapps/pokemon/htdocs/")
...
application.set_location_queue(new_location_queue)
...
if args.no_server:
	...
	application.run(threaded=True, use_reloader=False, debug=args.debug, host=args.host, port=args.port)
