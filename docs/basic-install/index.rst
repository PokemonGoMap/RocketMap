...
.. code-block:: bash
 ...
 Watch the `latest changes <https://github.com/RocketMap/RocketMap/commits/develop>`_ or discord to know when updating will require commands other than above. 
